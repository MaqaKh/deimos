...
<!-- Mirrored from templates.envytheme.com/startp/default/project-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Mar 2022 19:43:03 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
							...
							<ul class="navbar-nav nav ml-auto">
								...
								<li class="nav-item"><a href="#" class="nav-link active">Pages <i data-feather="chevron-down"></i></a>
									<ul class="dropdown_menu">
										...
										<li class="nav-item"><a href="#" class="nav-link active">Project <i data-feather="chevron-right"></i></a>
											<ul class="dropdown_menu">
												<li class="nav-item"><a href="project-1.html" class="nav-link active">Project Style 1</a></li>
