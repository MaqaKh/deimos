                    ...
                    <div class="col-lg-6 col-md-12">
                        <form id="contactForm">
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
										<input type="email" name="email" id="email" class="form-control" required data-error="Please enter your email" placeholder="<?php echo $lang["e-mail"];?>">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="phone_number" id="phone_number" required data-error="Please enter your number" class="form-control" placeholder="<?php echo $lang["tel"];?>">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-6">
                                    <div class="form-group">
										<input type="text" name="msg_subject" id="msg_subject" class="form-control" required data-error="Please enter your subject" placeholder="<?php echo $lang["subject"];?>">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
