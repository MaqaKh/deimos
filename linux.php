        ...
        <div class="row h-100 justify-content-center align-items-center">
            <div class="col-lg-6 col-md-12 services-content">
                <div class="section-title">
                    <h2> Linux Basics by Coshgun Hasanov </h2>
                    <div class="bar"></div>
                    <p>Learn Linux basics</p>
                </div>

                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="box">
                            <i data-feather="database"></i> Linux Concepts
                        </div>
                    </div>

                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="box">
                            <i data-feather="globe"></i> Installing Linux
                        </div>
                    </div>

                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="box">
                            <i data-feather="file"></i> File System
                        </div>
                    </div>

                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="box">
                            <i data-feather="trending-up"></i> Linux Fundamentals
                        </div>
                    </div>

                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="box">
                            <i data-feather="folder"></i> Shell scripting
                        </div>
                    </div>

                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="box">
                            <i data-feather="monitor"></i>  Networking
                        </div>
                    </div>

                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="box">
                            <i data-feather="mail"></i> Disk Management
                        </div>
                    </div>
