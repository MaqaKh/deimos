...
<!-- Mirrored from templates.envytheme.com/startp/default/feedback.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Mar 2022 19:43:03 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
			...
			<div class="startp-nav">
				<div class="container">
					<nav class="navbar navbar-expand-md navbar-light">
						<a class="navbar-brand black-logo" href="index.php"><img src="assets/img/logo.png" alt="logo"></a>
						<a class="navbar-brand white-logo" href="index.php"><img src="assets/img/white-logo.png" alt="logo"></a>
							...
							<ul class="navbar-nav nav ml-auto">
								<li class="nav-item"><a href="#" class="nav-link">Home <i data-feather="chevron-down"></i></a>
									<ul class="dropdown_menu">
										<li class="nav-item"><a href="#" class="nav-link">Home One <i data-feather="chevron-right"></i></a>
											<ul class="dropdown_menu">
												<li class="nav-item"><a href="index.php" class="nav-link">Light Green</a></li>
								...
								<li class="nav-item"><a href="#" class="nav-link active">Pages <i data-feather="chevron-down"></i></a>
									<ul class="dropdown_menu">
										...
										<li class="nav-item"><a href="terms-conditions.php" class="nav-link">Terms & Conditions</a></li>
						...
						<div class="others-option">
							...
							<a href="contact.php" class="btn btn-light">Support</a>
				...
				<div class="row">
					<div class="col-lg-3 col-md-6 col-sm-6">
						<div class="single-footer-widget">
							...
							<div class="logo white-logo">
								<a href="index.php"><img src="assets/img/white-logo.png" alt="logo"></a>
							</div>
					...
					<div class="col-lg-3 col-md-6 col-sm-6">
						<div class="single-footer-widget">
							...
							<ul class="list">
								...
								<li><a href="contact.php">Support Us</a></li>
					...
					<div class="col-lg-3 col-md-6 col-sm-6">
						<div class="single-footer-widget">
							...
							<ul class="footer-contact-info">
								...
								<li><i data-feather="mail"></i> Email: <a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#6b030e0707042b181f0a191f1b45080406"><span class="__cf_email__" data-cfemail="0169646d6d6e417275607375712f626e6c">[email&#160;protected]</span></a></li>
