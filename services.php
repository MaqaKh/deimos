...
<!-- Mirrored from templates.envytheme.com/startp/default/services-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Mar 2022 19:43:02 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6 col-md-6">
                        <div class="agency-services-box">
                            <img src="assets/img/agency-image/<?php echo $row['image']; ?>" alt="image">

                            <div class="content">
                                <h3><a href="service-detail.php?id=<?php echo $row['id']; ?>"><?php echo $row['title']; ?></a></h3>
								<a href="service-detail.php?id=<?php echo $row['id']; ?>" class="read-more-btn">Read More <i data-feather="plus-circle"></i></a>
                            </div>
                        </div>
                    </div>
